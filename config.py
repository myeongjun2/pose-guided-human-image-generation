...
def args():
    ...
    parser.add_argument('--dataset', default='fasion', choices=['market', 'fasion', 'prw', 'fasion128', 'fasion128128'],
    ...
    parser.add_argument("--warp_skip", default='stn', choices=['none', 'full', 'mask', 'stn', 'conv'],
    ...
    parser.add_argument("--pose_rep_type", default='hm', choices=['hm', 'stickhm', 'stickman'],
